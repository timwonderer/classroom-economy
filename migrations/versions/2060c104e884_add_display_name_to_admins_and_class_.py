...
def upgrade():
    ...
    with op.batch_alter_table('insurance_policy_blocks', schema=None) as batch_op:
        batch_op.create_index('ix_insurance_policy_blocks_block', ['block'], unique=False)
        batch_op.create_index('ix_insurance_policy_blocks_policy', ['policy_id'], unique=False)
    ...
    with op.batch_alter_table('store_item_blocks', schema=None) as batch_op:
        batch_op.create_index('ix_store_item_blocks_block', ['block'], unique=False)
        batch_op.create_index('ix_store_item_blocks_item', ['store_item_id'], unique=False)
    ...
    with op.batch_alter_table('student_blocks', schema=None) as batch_op:
        batch_op.create_index('ix_student_blocks_period', ['period'], unique=False)
        batch_op.create_index('ix_student_blocks_student_id', ['student_id'], unique=False)
    ...
    sa.Column('first_name', PIIEncryptedType(), nullable=False),
    ...
    with op.batch_alter_table('admins', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('has_assigned_students', sa.Boolean(), nullable=False))
    ...
    with op.batch_alter_table('store_items', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('bulk_discount_enabled', sa.Boolean(), nullable=False))
    ...
    with op.batch_alter_table('student_items', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('is_from_bundle', sa.Boolean(), nullable=False))
        batch_op.add_column(sa.Column('bundle_remaining', sa.Integer(), nullable=True))
        batch_op.add_column(sa.Column('quantity_purchased', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    with op.batch_alter_table('students', schema=None) as batch_op:
        ...
        batch_op.alter_column('first_name',
               existing_type=PIIEncryptedType(),
    ...
    with op.batch_alter_table('student_blocks', schema=None) as batch_op:
        batch_op.drop_index('ix_student_blocks_student_id')
        batch_op.drop_index('ix_student_blocks_period')

    op.drop_table('student_blocks')
    with op.batch_alter_table('store_item_blocks', schema=None) as batch_op:
        batch_op.drop_index('ix_store_item_blocks_item')
        batch_op.drop_index('ix_store_item_blocks_block')
    ...
    with op.batch_alter_table('insurance_policy_blocks', schema=None) as batch_op:
        batch_op.drop_index('ix_insurance_policy_blocks_policy')
        batch_op.drop_index('ix_insurance_policy_blocks_block')
