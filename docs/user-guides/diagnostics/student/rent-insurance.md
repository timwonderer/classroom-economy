---
title: Troubleshooting Rent and Insurance
description: Why a rent bill, late fee, or insurance claim looks wrong, and what your teacher needs to know.
...
# Troubleshooting Rent and Insurance
...
- If rent itemization is active, you can only buy rent items until you pay your full rent.

## If you cannot buy insurance, check these first:
- Is the policy active and does it belong to your current class?
- Are you already enrolled in that policy or tier?
...
- Tell them the policy name, claim type, and the exact error message.
- Tell them the rent due date shown on screen.
