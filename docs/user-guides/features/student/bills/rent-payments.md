...
1. Find **Total due for this bill**. Under it, the amount is itemised — *Rent · Period X* on one line, each *Late fee* on its own line with the date it arose.
...
This card states the rules your teacher set: the rent amount and how often it is charged, and the grace period — how many days late you can pay without a fee.
...
The rent page does not list your benefits. The **Store** does.

Browse the store and rent-covered items are marked directly on the item:

- **Included in your rent!** — already yours, nothing to buy
- **Rent Perk** with *n free uses remaining* — free while your uses last
- **Rent Perk price: $0.00** — this purchase costs nothing right now

If you are wondering what your rent buys you, that is where to look.

## Important notes

> [!IMPORTANT]
> **Rent and late fees are one bill.** Paying settles both together. There is no way to pay a late fee on its own, and no way to dodge one by paying only the rent.
