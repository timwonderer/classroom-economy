...
| Expose Existing Export + UI | 1 week | Jan 6 - Jan 12, 2026 |
| Add New Export Routes | 2-3 weeks | Jan 13 - Feb 2, 2026 |
...
**Already Implemented:**
- ✅ Student roster export route exists (`/export-students` in `admin.py:5211`)
- ✅ CSV generation with proper escaping and sanitization
- ✅ Multi-tenancy scoping with `_scoped_students()`
- ✅ Includes: student names, block, balances, insurance, rent status

**Missing:**
- ❌ UI button to access student export (route exists but not linked)
- ❌ Transaction history export
- ❌ Attendance records export
- ❌ Payroll history export
- ❌ Store purchase history export

### User Stories

**As a teacher, I want to:**
- ~~Export my class roster with current balances (CSV)~~ **Already exists - needs UI button**
...
**Phase 1: Expose Existing Student Export (1 week)**
- [ ] Add "Export Students" button to Student Management page
- [ ] Test existing `/export-students` route for bugs
- [ ] Verify multi-tenancy scoping is correct
- [ ] Update teacher manual with export instructions

**Phase 2: Add New Export Routes (2-3 weeks)**
- [ ] Create `app/utils/export.py` module for shared export utilities
- [ ] Implement transaction export route with date filtering
- [ ] Implement attendance export route with date filtering
- [ ] Implement payroll history export route
- [ ] Implement store purchases export route
- [ ] All exports MUST use proper multi-tenancy scoping (join_code)

**Phase 3: Enhanced Features (Optional, 1 week)**
- [ ] Add date range filtering UI for historical exports
- [ ] Implement rate limiting (max 10 exports per hour per teacher)
- [ ] Add export form modal with date range picker
- [ ] Optional: Add encryption for sensitive exports (PII)
- [ ] Add export activity logging
- [ ] Write comprehensive tests for all new exports
- [ ] Update teacher manual with all export features

#### Security Considerations

- ✅ All exports scoped by `join_code` (multi-tenancy safe)
- ✅ Admin authentication required
- ✅ Rate limiting to prevent abuse
- ✅ PII encryption optional for sensitive data
- ✅ Export activity logged for audit trail
- ⚠️ Consider GDPR compliance for data export (right to data portability)
