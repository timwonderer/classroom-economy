...
def test_admin_payroll_displays_scoped_balances_only(client):
    ...
    class_a = create_class_scope(teacher_user=teacher_a, join_code="APSB1", display_name="A")
    class_b = create_class_scope(teacher_user=teacher_b, join_code="APSB2", display_name="A")
    db.session.flush()
