...
def setup_multi_class_student(client):
    ...
    with FEATContext("FEAT-IDEN-001", idempotency_key="setup_multi_class_student:classes"):
        class_1a = create_class_scope(teacher_user=teacher1, join_code="CCS1A", display_name="Class 1A", section="A")
        class_2b = create_class_scope(teacher_user=teacher2, join_code="CCS2B", display_name="Class 2B", section="B")
        class_3c = create_class_scope(teacher_user=teacher3, join_code="CCS3C", display_name="Class 3C", section="C")
        class_unclaimed = create_class_scope(teacher_user=teacher1, join_code="CCSUN", display_name="Unclaimed Z")
...
def setup_single_class_student(client):
    ...
    with FEATContext("FEAT-IDEN-001", idempotency_key="setup_single_class_student:class"):
        class_single = create_class_scope(teacher_user=teacher, join_code="CCSS1", display_name="Single D")
