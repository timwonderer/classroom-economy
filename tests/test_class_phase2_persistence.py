...
class TestEconomicEngineImmutability:
    ...
    def test_economic_engine_created_successfully(self, app, class_economy):
    ...
    def test_economic_engine_prevents_field_modification(self, app, class_economy):
    ...
    def test_economic_engine_can_set_field_before_commit(self, app, class_economy):
    ...
    def test_economic_engine_null_fields_preserved(self, app, class_economy):
...
class TestEconomicEngineVersionChain:
    ...
    def test_version_chain_creation(self, app, class_economy):
    ...
    def test_restrict_constraint_prevents_deletion_of_referenced_version(self, app, class_economy):
    ...
    def test_first_version_has_null_previous_id(self, app, class_economy):
...
class TestClassFeatureAppendOnly:
    ...
    def test_multiple_feature_entries_same_class_feature(self, app, class_economy):
    ...
    def test_composite_primary_key_uniqueness(self, app, class_economy):
    ...
    def test_enabled_names_for_class_latest_only(self, app, class_economy):
        ...
        with app.app_context():
            ...
            enabled = ClassFeature.enabled_names_for_class(class_economy.class_id)

            # Should only include banking (latest enabled)
            assert "banking" in enabled
            assert "payroll" not in enabled

    def test_enabled_names_for_class_respects_null_version_id(self, app, class_economy):
    ...
    def test_enabled_names_for_class_empty_when_no_entries(self, app, class_economy):
        """Test that enabled_names_for_class returns empty set when no entries exist."""
        with app.app_context():
            enabled = ClassFeature.enabled_names_for_class(class_economy.class_id)
            assert enabled == set()

    def test_enabled_names_for_class_cascade_delete_on_version(self, app, class_economy):
...
class TestEconomicEngineCheckConstraints:
    ...
    def test_economy_policy_mode_valid_values(self, app, class_economy):
    ...
    def test_interest_rate_range_constraint(self, app, class_economy):
    ...
    def test_interest_rate_null_allowed(self, app, class_economy):
    ...
    def test_expected_weekly_hours_positive_constraint(self, app, class_economy):
    ...
    def test_expected_weekly_hours_null_allowed(self, app, class_economy):
    ...
    def test_interest_calculation_type_constraint(self, app, class_economy):
    ...
    def test_compound_frequency_constraint(self, app, class_economy):
    ...
    def test_interest_accrual_frequency_constraint(self, app, class_economy):
    ...
    def test_interest_payout_frequency_constraint(self, app, class_economy):
...
class TestClassFeatureCheckConstraints:
    ...
    def test_feature_valid_values(self, app, class_economy):
