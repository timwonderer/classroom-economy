...
def test_hall_pass_active_requires_teacher_seat_public_id_and_scopes_to_one_class(client):
    ...
    class_a = create_class_scope(teacher_user=admin, join_code="RASWA", section="A")
    class_b = create_class_scope(teacher_user=admin, join_code="RASWB", section="B")
    class_other = create_class_scope(teacher_user=other_admin, join_code="RASWC", section="C")
    db.session.flush()
...
def test_approve_redemption_requires_membership(client):
    ...
    class_row = create_class_scope(teacher_user=admin_owner, join_code="RASWD")
    intruder_class_row = create_class_scope(teacher_user=admin_intruder, join_code="RASWE")
    db.session.flush()
...
def test_file_claim_scoped_to_class(client):
    ...
    class_a = create_class_scope(teacher_user=admin, join_code="RASWF", section="A")
    class_b = create_class_scope(teacher_user=admin, join_code="RASWG", section="B")
    db.session.flush()
