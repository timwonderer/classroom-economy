...
def test_pay_rate_isolation_by_class_id(client):
    ...
    class_a = seed_class_with_seat(teacher=teacher, join_code="PAYRATEA").class_row
    class_b = seed_class_with_seat(teacher=teacher, join_code="PAYRATEB").class_row
...
def test_daily_limit_isolation_by_class_id(client):
    ...
    class_x = seed_class_with_seat(teacher=teacher, join_code="PAYLIMITX").class_row
    class_y = seed_class_with_seat(teacher=teacher, join_code="PAYLIMITY").class_row
...
def test_duplicate_active_settings_fail_closed(client):
    ...
    class_a = seed_class_with_seat(teacher=teacher, join_code="PAYDUPA").class_row
