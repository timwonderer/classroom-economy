...
def process_claim(claim_id):
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        if claim.policy.claim_type != 'non_monetary' and new_status == 'approved' and old_status != 'approved':
            approved_claims_count = approved_claims.count()
            if claim.policy.max_claims_count and old_status != 'approved' and approved_claims_count >= claim.policy.max_claims_count:
            ...
            if claim.policy.claim_type == 'legacy_monetary' and form.approved_amount.data:
